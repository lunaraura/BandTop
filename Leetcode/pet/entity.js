...
const familyInnateVariation = {
    canine: {pAtk:{t: 0.5, r: 10}, eAtk:{t: 0, r: 1}, maxHP: {t: 0, r: 20},
        speed: {t: 0, r: 1}, def: {t: 0.5, r: 2}, castSpd: {t: 0, r: 1}},
    feline: {pAtk:{t: 0.5, r: 10}, eAtk:{t: 0.5, r: 1}, maxHP: {t: 0, r: 15},
        speed: {t: 0, r: 2}, def: {t: 0.5, r: 1}, castSpd: {t: 0, r: 1}},
    reptile: {pAtk:{t: 0.5, r: 20}, eAtk:{t: 0.5, r: 1}, maxHP: {t: 0, r: 10},
        speed: {t: 0.5, r: 1}, def: {t: 0.5, r: 1}, castSpd: {t: 0, r: 1}},
    bird: {pAtk:{t: 1, r: 10}, eAtk:{t: 0, r: 10}, maxHP: {t: 0, r: 10},
        speed: {t: 0, r: 3}, def: {t: 0.5, r: 1}, castSpd: {t: 0, r: 1}},
    bug: {pAtk:{t: 0.5, r: 5}, eAtk:{t: 0.5, r: 1}, maxHP: {t: 0, r: 10},
        speed: {t: 0, r: 3}, def: {t: 0.5, r: 1}, castSpd: {t: 0, r: 1}},
    spectre: {pAtk:{t: 1, r: 5}, eAtk:{t: 0.5, r: 1}, maxHP: {t: 0, r: 10},
        speed: {t: 0, r: 5}, def: {t: 0.5, r: 1}, castSpd: {t: 0, r: 1}},
    elemental: {pAtk:{t: 1, r: 5}, eAtk:{t: 0.5, r: 1}, maxHP: {t: 0, r: 10},
        speed: {t: 0, r: 2}, def: {t: 0.5, r: 1}, castSpd: {t: 0, r: 1}},
    mecha: {pAtk:{t: 0, r: 10}, eAtk:{t: 0, r: 10}, maxHP: {t: 0, r: 40},
        speed: {t: 0.5, r: 10}, def: {t: 0.5, r: 10}, castSpd: {t: 0, r: 10}},
}
...
//spawning entities
teamSpawner("A", 5, "houseDog", );
let mechBird = entitySpawner("bird", canvas.width/2, canvas.height/2, "B", 60);
teamSpawner("B", 1, "houseCat", 0);
